...
namespace ShellDll
{
    public static class ShellImageList
    {
        ...
        public static int GetFileImageIndex(string path, FileAttributes attr)
        {
            ShellAPI.SHFILEINFO shfiSmall = new ShellAPI.SHFILEINFO();
            ShellAPI.SHGetFileInfo(path, (ShellAPI.FILE_ATTRIBUTE)attr, ref shfiSmall, ShellAPI.cbFileInfo,
