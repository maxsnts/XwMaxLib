...
{
    sealed class GrayStyles : KRBProfessionalColors
    {
        ...
        protected override void InitColors(Dictionary<KnownColors, Color> rgbTable)
        {
            ...
            rgbTable[KnownColors.MenuStripGradientEnd] = Color.FromArgb(220, 220, 234);
            ...
            rgbTable[KnownColors.RaftingContainerGradientEnd] = Color.FromArgb(220, 220, 234);
            ...
            rgbTable[KnownColors.ToolStripContentPanelGradientBegin] = Color.FromArgb(215, 215, 229);
            rgbTable[KnownColors.ToolStripContentPanelGradientEnd] = Color.FromArgb(215, 215, 229);
            ...
            rgbTable[KnownColors.ToolStripPanelGradientEnd] = Color.FromArgb(220, 220, 234);
